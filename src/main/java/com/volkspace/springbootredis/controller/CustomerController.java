package com.volkspace.springbootredis.controller;
...
import com.volkspace.springbootredis.service.CustomerService;
...
public class CustomerController {
	...
	public ResponseEntity<?> getCustomer(@PathVariable String id) {
		Optional<?> customer = customerService.retrieveCustomer(id);
